...
*   **Mobile App (Flutter):** You **must** use `syncfusion_flutter_charts` and wrap the charts in a `RepaintBoundary` widget. Buffer the incoming BLE data at 30 FPS. Do not update the UI per-byte, or the app will freeze.
