...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--output_file',type=str, default='saved_model')
        ...
        parser.add_argument('--patch_size', default=(992), help='Size of the patches extracted from the image')
        parser.add_argument('--spacing', default=[0.7], help='Original Resolution')
        ...
        parser.add_argument('--batch_size', type=int, default=80, help='batch size, depends on your machine')
