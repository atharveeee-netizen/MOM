...
| **`diagram_wearable_dsp_storage.png`** | Circular state ring buffers, CMSIS-DSP NLMS execution loop, and flash cache | Embedded firmware architecture design | 1000x750 PNG | **Page 8 (Methodology)** | Details deterministic DMA packet handling and 10-tap FIR convolution. |
